...
use app\http\controller\SecondServer as SecondServer;
 
class SecondWorker extends Command
{
    // 设置处理控制器以及相关指令
    protected function configure()
    {
        $this->setName('SecondWorker') //设置处理控制器
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        // 实例化处理器
        $worker = new SecondServer($host, $port, $context);
