...
class TcpConnection extends ConnectionInterface
{
    ...
    {
        // echo "[TcpConnection->getRemoteIp]\n";
    ...
    {
        // echo "[TcpConnection->getRemotePort]\n";
    ...
    {
        // echo "[TcpConnection->getRemoteAddress]\n";
    ...
    {
        // echo "[TcpConnection->getLocalPort]\n";
        $address = $this->getLocalAddress();
        $pos = strrpos($address, ':');
        if (!$pos) {
            return 0;
    ...
    {
        // echo "[TcpConnection->getLocalAddress]\n";
    ...
    {
        // echo "[TcpConnection->getSendBufferQueueSize]\n";
    ...
    {
        // echo "[TcpConnection->getRecvBufferQueueSize]\n";
    ...
    public function doSslHandshake($socket){
        // echo "[TcpConnection->doSslHandshake]\n";
        if (feof($socket)) {
            $this->destroy();
            return false;
        }
    ...
    {
        // echo "[TcpConnection->consumeRecvBuffer]\n";
    ...
    {
        // echo "[TcpConnection->checkBufferWillFull]\n";
    ...
    {
        // echo "[TcpConnection->bufferIsFull]\n";
    ...
    {
        // echo "[TcpConnection->bufferIsEmpty]\n";
