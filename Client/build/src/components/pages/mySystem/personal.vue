...
<script>
console.log("PAGES_MYSYSTEM_PERSONAL_VUE");
...
import root from '@/config/root.js'
    export default {
        data(){
            return{
                disableClear: false,
                username: this.$store.state.songInfo.user.username,
                ...
                oriActive: false,
                newActive: false,
                purimg: [ this.pic2 = 'http://192.168.0.100'  + this.$store.state.songInfo.user.head],
                imgData: {
        ...
        methods: {
            ...
            previewPic: function(event){
                ...
                headers:{'Content-Type':'multipart/form-data'}  
                    ...
                    console.log(response);
                    url = 'http://192.168.0.100' + response.data;
                    console.log(url)
